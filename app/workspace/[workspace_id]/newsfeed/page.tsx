        ...
        <div className="p-6">
          ...
          {isLoading ? (
            <div className="flex justify-center items-center h-64">
              <div className="animate-spin rounded-full border-4 border-t-4 border-emerald-600 w-12 h-12"></div>
            </div>
          ) : (
            <div className="flex flex-col gap-6">
              {news && news.length > 0 ? (
                ...
                <p className="text-center py-8 text-gray-500">No news available.</p>
              )}
            </div>
          )}
        </div>
