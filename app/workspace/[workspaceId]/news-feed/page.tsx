...
export default function NewsfeedPage({ params }: WorkspaceDetailPageProps) {
...
//   }
  ...
  const posts = [
    ...
    },
    {
      ...
      username: "BobMartin",
      date: "Mar 24, 2025",
      content: "Just finished a big project with the team. Great work, everyone!",
      likes: 80,
      comments: 12,
    },
  ];
    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 bg-gray-50">
        ...
        <div className="p-6">
            <div className="flex flex-row justify-end">
                <GradientButton text="Post" width='w-40' onClick={()=>setIsModalOpen(true)}/>
                </div>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        ...
        <div className="flex flex-col w-full h-full gap-4">
          ...
          <textarea 
                placeholder="Content ..."
                className="w-full h-32 resize-none  p-2 mb-4 text-gray-800"
                value={content}
          ...
          <div className='flex flex-row gap-2 text-gray-600 cursor-pointer'>
            <Image/>
